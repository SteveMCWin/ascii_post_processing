...
void main() {
	...
	color += imageLoad(color_image, uv + ivec2( 1, 0)).xyz * 0.15;
	color += imageLoad(color_image, uv + ivec2(-1, 0)).xyz * 0.15;
	color += imageLoad(color_image, uv + ivec2( 2, 0)).xyz * 0.12;
	color += imageLoad(color_image, uv + ivec2(-2, 0)).xyz * 0.12;
	color += imageLoad(color_image, uv + ivec2( 3, 0)).xyz * 0.09;
	color += imageLoad(color_image, uv + ivec2(-3, 0)).xyz * 0.09;
	color += imageLoad(color_image, uv + ivec2( 4, 0)).xyz * 0.05;
	color += imageLoad(color_image, uv + ivec2(-4, 0)).xyz * 0.05;
	// Apply our changes.
